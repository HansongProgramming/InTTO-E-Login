...
const EDIT_INTERN_URL = id => `http://192.168.0.87:3000/editIntern/${encodeURIComponent(id)}`;
const DELETE_INTERN_URL = name => `http://192.168.0.87:3000/deleteIntern/${encodeURIComponent(name)}`;
